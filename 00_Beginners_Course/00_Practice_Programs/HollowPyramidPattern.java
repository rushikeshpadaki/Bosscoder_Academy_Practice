 ...
 *
 * Description:
 * This program prints a hollow pyramid pattern of `*` characters.
 ...
 * - The second inner loop prints `*` characters at the edges and spaces inside to form a hollow pattern.
 *
 * Algorithm:
 ...
 *    - Second inner loop prints `*` at the edges and spaces inside
...
public class HollowPyramidPattern {
    ...
    /**
     * Prints a hollow pyramid pattern of `*` characters.
     *
